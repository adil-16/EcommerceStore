...
export default function EnterCode({ callback, reset, isLoading }) {
  ...
  return (
    <div className="flex gap-10 relative">
      {[0, 1, 2, 3].map((index) => (
        <input
          className="text-5xl bg-transparent w-20 h-20 flex text-center border border-fieldBorder rounded-full focus:outline-none focus:border-primary text-primary placeholder:placeholder"
          key={index}
          placeholder="0"
          type="text"
          maxLength={1}
